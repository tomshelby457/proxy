...
* Deploy this proxy to DigitalOcean (free promo codes!) and run it on your own domain.
  [Learn More](https://github.com/tomshelby457/proxy/wikis/Deploy-for-free)
...
[this guide](https://github.com/tomshelby457/proxy/wikis/Deploy-for-free) and Avoid AdBlock
